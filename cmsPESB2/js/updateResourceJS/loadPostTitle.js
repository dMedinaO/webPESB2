...
var loadDataJSON = function(){
  ...
  http_request.onreadystatechange = function(){
    if (http_request.readyState == 4  ){
      ...
      $(".menu1").html(jsonObj.postTitle.redTitle);
      $(".menu2").html(jsonObj.postTitle.title);
      $(".menu3").html(jsonObj.postTitle.description);
    }
  }
...
var editar01 = function(){
  $("#editTitle01").on("click", function(){
    ...
    $.ajax({
      method:"POST",
      url: "../php/updateResource/updatePostTitulo.php?option=redTitle",
      data: {
          "content": valueInput
          }
    }).done( function( info ){
...
var editar02 = function(){
  $("#editTitle02").on("click", function(){
    ...
    $.ajax({
      method:"POST",
      url: "../php/updateResource/updatePostTitulo.php?option=title",
      data: {
          "content": valueInput
          }
    }).done( function( info ){
...
var editar03 = function(){
  $("#editTitle03").on("click", function(){
    ...
    $.ajax({
      method:"POST",
      url: "../php/updateResource/updatePostTitulo.php?option=description",
      data: {
          "content": valueInput
          }
    }).done( function( info ){
