...
var loadDataJSON = function(){
  ...
  http_request.onreadystatechange = function(){
    if (http_request.readyState == 4  ){
      ...
      $(".menu1").html(jsonObj.groupInfo.redTitle);
      $(".menu2").html(jsonObj.groupInfo.title);
      $(".menu3").html(jsonObj.groupInfo.description);
...
var editar01 = function(){
  $("#editTitle01").on("click", function(){
    ...
    $.ajax({
      method:"POST",
      url: "../php/updateResource/updateGroupValues.php?option=redTitle",
      data: {
          "content": valueInput
          }
    }).done( function( info ){
...
var editar02 = function(){
  $("#editTitle02").on("click", function(){
    ...
    $.ajax({
      method:"POST",
      url: "../php/updateResource/updateGroupValues.php?option=title",
      data: {
          "content": valueInput
          }
    }).done( function( info ){
...
var editar03 = function(){
  $("#editTitle03").on("click", function(){
    ...
    $.ajax({
      method:"POST",
      url: "../php/updateResource/updateGroupValues.php?option=description",
      data: {
          "content": valueInput
          }
    }).done( function( info ){
